    ...
    return (
        <div>
            <div
                className={
                    shadow
                        ? 'fixed w-full bg-white h-20 shadow-lg shadow-gray-200 z-[100] '
                    ...
                    >
                        <div className="flex flex-col  ">
                            <ul className="ml-2 text-white uppercase ">
                                ...
                                <Link href="/">
                                    <li className="py-4 text-sm hover:text-[#38e7c4] hover:underline cursor-pointer hover:animate-pulse">
                                        Seller
                                    </li>
                                </Link>
                            </ul>
